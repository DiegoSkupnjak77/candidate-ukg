...
namespace TraineeProgram.Persistence.Repositories
{
    public class OfferLetterRepository : IOfferLetterRepository
    {
        ...
        {
            var UserOfferLetter = _context.UserRs.FirstOrDefault(c => c.UserId == idUser);
            var CandidateOfferLetter = _context.Candidates.FirstOrDefault(c => c.CandidateId == idCandidate);
            var JobOpeningOfferLetter = _context.JobOpenings.FirstOrDefault(c => c.JobOpeningId == idJobOpening);
